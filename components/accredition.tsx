export default function() {
  ...
  return (
    <section className="text-center bg-blue-600 text-white mt-12">
      <div className="r-w py-12 space-y-6">
          ...
          {news.map((item, i) => (
            ...
            >
              <img
                src={item.img}
                alt={item.alt}
                className="object-cover aspect-video border-b border-b-gray-400"
              />
